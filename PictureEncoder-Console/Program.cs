...
namespace PictureEncoder
{
	...
	public class EncodeCommand : Command
	{
		...
		public async void CommandHandler(CommandOption options)
		{
			...
			using var outputStream = await PicEncoder.Encode(options.Password, inputStream, progressBar);
			progressBar.Dispose();
	...
	public class DecodeCommand : Command
	{
		...
		public async void CommandHandler(CommandOption options)
		{
			...
			using var outputStream = await PicEncoder.Decode(options.Password, inputStream, progressBar);
			progressBar.Dispose();
